...
c0 = MhsTIF('Eko', 10, 'sukoharjo', 240000)
c1 = MhsTIF('Ida', 51, 'sragen', 230000)
c2 = MhsTIF('Joni', 2, 'surakarta', 250000)
c3 = MhsTIF('Chandra', 18, 'surakarta', 235000)
c4 = MhsTIF('Erika', 4, 'boyolali', 240000)
c5 = MhsTIF('Fandi', 31, 'salatiga', 250000)
c6 = MhsTIF('Danu', 13, 'klaten', 245000)
c7 = MhsTIF('Galuh', 5, 'wonogiri', 245000)
c8 = MhsTIF('Yanto', 23, 'klaten', 245000)
